//
//  SelectTradeModalViewController.swift
//  stocksignal
//
...
class SelectTradeModalViewController: UIViewController {
    static let id = "SelectTradeModalViewController"
...
//        }
    ...
    private func trade(price:Int) {
        ...
        let viewController = InstantModalViewController(currentPrice: price, stockName: self.stockName, quantity: self.quantity, viewModel: self.viewModel)
