//
//  NewScenarioSellTradingCollectionViewCell.swift
//  stocksignal
//
...
final class NewScenarioSellTradingCollectionViewCell: UICollectionViewCell {
    static let id = "NewScenarioSellTradingCollectionViewCell"
    ...
    public func setLabel(currentPrice: Int, viewModel: NewScenarioViewModel) {
        upInput.rx.text.orEmpty
            .subscribe(onNext: { text in
                ...
                viewModel.targetPrice_sell_trade_up1 = expectPrice
        ...
        downInput.rx.text.orEmpty
            .subscribe(onNext: { text in
                ...
                viewModel.targetPrice_sell_trade_down2 = expectPrice
        ...
        upInput2.rx.text.orEmpty
            .subscribe(onNext: { text in
                ...
                viewModel.targetPrice_sell_trade_down1 = expectPrice
            })
            .disposed(by: disposeBag)
        ...
        downInput2.rx.text.orEmpty
            .subscribe(onNext: { text in
                ...
                viewModel.targetPrice_sell_trade_up2 = expectPrice
            })
            .disposed(by: disposeBag)
    }
