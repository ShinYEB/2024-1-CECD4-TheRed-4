//
//  PracticeButtonCollectionViewCell.swift
//  stocksignal
//
...
final class PracticeButtonCollectionViewCell: UICollectionViewCell {
    static let id = "PracticeButtonCollectionViewCell"
